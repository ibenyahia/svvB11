...
hp0    = 0.3048*([]);      	  % pressure altitude in the stationary flight condition [m]
V0     = 0.514444*([]);            % true airspeed in the stationary flight condition [m/sec]
alpha0 = (pi/180)*([]);       	  % angle of attack in the stationary flight condition [rad]
th0    = (pi/180)*([]);       	  % pitch angle in the stationary flight condition [rad]
